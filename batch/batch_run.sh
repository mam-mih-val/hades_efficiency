...
echo "loading /lustre/hades/user/mmamaev/install/root-6.20.04-centos7-cxx17/bin/thisroot.sh"
source /lustre/hades/user/mmamaev/install/root-6.20.04-centos7-cxx17/bin/thisroot.sh
